...
export const mockWorktrees: Worktree[] = [
  ...
  },
  {
    ...
    mood: 'active',
    changes: [
      { path: 'src/auth/oauth.ts', status: 'modified' as GitStatus, insertions: 32, deletions: 10 },
      { path: 'src/auth/jwt.ts', status: 'added' as GitStatus, insertions: 58, deletions: 0 },
      { path: 'src/auth/types.ts', status: 'modified' as GitStatus, insertions: 12, deletions: 4 },
      { path: 'tests/auth/oauth.test.ts', status: 'added' as GitStatus, insertions: 24, deletions: 0 },
      { path: 'package.json', status: 'modified' as GitStatus, insertions: 6, deletions: 2 },
    ],
  },
  {
    ...
    mood: 'active',
    changes: [
      { path: 'src/hooks/useWatcher.ts', status: 'modified' as GitStatus, insertions: 15, deletions: 3 },
      { path: 'tests/hooks/useWatcher.test.ts', status: 'modified' as GitStatus, insertions: 10, deletions: 1 },
    ],
  },
  {
